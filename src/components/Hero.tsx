...
const DeferredVideo = ({ src, poster, className }: { src: string; poster: string; className: string }) => {
    ...
    <>
      ...
      <section className="md:hidden flex flex-col pt-[90px]">
        <div className="relative w-full aspect-square overflow-hidden">
          <DeferredVideo src={demoVideo} poster={heroBanner} className="w-full h-full object-cover object-center" />
          ...
          <div className="absolute bottom-0 left-0 right-0 p-5 space-y-3">
            ...
            {/* Subtitle — pont émotionnel avec l'ad */}
            <p className="text-[11px] font-sans-body uppercase tracking-[0.2em] text-white/70">{t("hero.subtitle")}</p>
      ...
      <section className="hidden md:flex relative min-h-[85vh] items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10 pt-32 pb-16">
          ...
          >
            ...
            <motion.p
              variants={fadeUp}
              className="text-sm font-sans-body uppercase tracking-[0.25em] text-muted-foreground"
            >
              {t("hero.subtitle")}
            </motion.p>
            ...
            <motion.h1
              variants={fadeUp}
              className="text-4xl lg:text-5xl font-serif font-bold leading-[1.1] text-foreground"
            >
              {t("hero.title1")} <span className="text-gold italic">{t("hero.title2")}</span>
            </motion.h1>
            ...
            <motion.div variants={fadeUp} className="flex items-baseline gap-3">
              ...
              <span className="bg-red-500/10 text-red-500 text-[11px] font-bold px-2.5 py-0.5 rounded-full uppercase">
                -50%
              </span>
            </motion.div>
            ...
            <motion.div
              variants={fadeUp}
              className="flex items-center gap-4 text-xs text-muted-foreground font-sans-body pt-1"
            >
              <span>{t("hero.freeShipping")}</span>
              <span className="w-px h-3 bg-border" />
              <span>{t("hero.securePayment")}</span>
