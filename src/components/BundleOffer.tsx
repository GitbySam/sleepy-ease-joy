...
const BundleOffer = () => {
  ...
  const bundles = [
    ...
    { qty: 2, label: "2 Sleep&zy", price: `${currencySymbol}59.90 CAD`, oldPrice: `${currencySymbol}119.80 CAD`, perUnit: `${currencySymbol}29.98 CAD${t("bundle.perUnit")}`, tag: "DUO PACK", packValue: "Duo Pack", priceNum: 59.90 },
